 ...
 */
@WebServlet("/Certificate_of_Citizenship")
public class Certificate_of_Citizenship extends HttpServlet {
     ...
     */
    public Certificate_of_Citizenship() {
        super();

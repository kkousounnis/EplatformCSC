 ...
 */
@WebServlet("/insurance_broker_certificate")
public class insurance_broker_certificate extends HttpServlet {
     ...
     */
    public insurance_broker_certificate() {
        super();
	...
	if(validation.equals("DECLINED")){
		...
		out.print("<!DOCTYPE html>\r\n" + 
				...
				" <div>\r\n" + 
				" \r\n" + 
				" <h1>Βεβαίωση Ασφαλιστικής Ενημερότητας</h1>\r\n" + 
				" \r\n" + 
				" <table>\r\n" + 
				" <tr>\r\n" + 
				"    <th>Επώνυμο:</th>\r\n" + 
				...
				" </table>\r\n" + 
				" \r\n" + 
				" <p>* Δεν οφείλει ληξιπρόθεσμες ασφαλιστικές εισφορές.</p>\r\n" + 
				" \r\n" + 

package Main;
import java.sql.*;
public class DeleteRowFromUserFormsTable {
	 ...
	 static final String JDBC_DRIVER = "com.mysql.jdbc.Driver";  
	   ...
	   User u=new User();
		...
		public void DeleteRowUserForms(String n,String p) {
			...
			Connection conn = null;
			   ...
			   try{
			      ...
			      System.out.println("Delete records from userforms");
			      stmt = conn.createStatement();
			        sql = " DELETE  FROM userforms WHERE USERNAME='"+n+"' and PASSWORD='"+p+"' " ;

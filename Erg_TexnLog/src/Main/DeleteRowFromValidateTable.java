package Main;
import java.sql.*;
public class DeleteRowFromValidateTable {
	 ...
	 static final String JDBC_DRIVER = "com.mysql.jdbc.Driver";  
	   ...
	   User u=new User();
		...
		public void DeleteRowValidate(String n,String p) {
			...
			Connection conn = null;
			   ...
			   try{
			      ...
			      System.out.println("Delete records from ValidationForm");
			      stmt = conn.createStatement();
			        sql = " DELETE  FROM validateform WHERE USERNAME='"+n+"' and PASSWORD='"+p+"' " ;
